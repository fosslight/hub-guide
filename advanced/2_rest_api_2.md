...
<table>
    <thead>
        <tr>
            <th scope="col">API</th>
            <th scope="col" style="text-align: center; white-space: nowrap;">응답 형식</th>
...
<h2 class="specific-title" id="3rd-party-info"> 2. 3rd Party 정보 조회</h2>
<table>
    <thead>
        <tr>
            <th scope="col">API</th>
...
<h2 class="specific-title" id="project-info"> 3. Project 정보 조회, 생성, FOSSLight Report 등록, Packaging 파일 업로드, BOM Export, Project 비교</h2>
<table>
    <thead>
        <tr>
            <th scope="col">API</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                Project에 이전 프로젝트에서 리뷰된 오픈소스 정보를 로드함 (Identification confirm 된 프로젝트만 로드 가능)<br><br>
                <ul class="description-list">
                    <li><strong class="highlight-black"><span style="color: red;">(required)</span> id</strong>: 대상 project ID</li>
        ...
        <tr>
            ...
            <td><span class="highlight">-</span></td>
            <td>
                Project에 오픈소스 분석된 리포트 파일을 업로드함<br><br>
                <ul class="description-list">
...
<h2 class="specific-title" id="Vul-info"> 4. Vulnerability 정보 조회</h2>
<table>
    <thead>
        <tr>
            <th scope="col">API</th>
...
<h2 class="specific-title" id="self-check-info"> 5. Self-Check 생성, FOSSLight Report 등록</h2>
<table>
    <thead>
        <tr>
            <th scope="col">API</th>
...
<h2 class="specific-title" id="api-info"> 6. API 활용시, Code 값 확인</h2>
<table>
    <thead>
        <tr>
            <th scope="col">API</th>
...
<h2 class="specific-title" id="binary-db-info"> 7. Binary DB 정보 조회</h2>
<table>
    <thead>
        <tr>
            <th scope="col">API</th>
