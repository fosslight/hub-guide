...
- Project의 Identification 단계가 Confirm된 상태에서 BOM에 포함된 OSS 중 기준점수 이상인 CVSS Score를 가진 CVE ID가 발견되거나, 기준점수 이상에서 미만으로 변경될 경우, Vulnerability Score 변경 알림 메일이 발송됩니다.  
