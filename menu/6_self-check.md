...
1. [Self-Check Project 생성 및 OSS 정보 입력](../tutorial/2_self_check/1_create_project.md)
2. [OSS 및 License 정보 확인](../tutorial/2_self_check/2_verify_oss_license.md)
3. [Vulnerability 정보 확인](../tutorial/2_self_check/3_verify_vulnerability.md)
4. [Download location 정보로 Open Source 검토하기](../tips/1_common/2_pre_review/README.md)  
